...
<flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
    ...
    <flux:navbar class="-mb-px max-lg:hidden">
        ...
        <flux:navbar.item icon="layout-grid" :href="route('nodes.index')" :current="request()->routeIs('nodes.index')" wire:navigate>
            Nodes
        </flux:navbar.item>
    </flux:navbar>
    ...
    <flux:navbar class="me-1.5 space-x-0.5 rtl:space-x-reverse py-0!">
        ...
        <flux:tooltip :content="__('Repository')" position="bottom">
            <flux:navbar.item
                ...
                icon="folder-git-2"
                href="https://github.com/laraveltoiot/open-iot-cloud-laravel"
                target="_blank"
                :label="__('Repository')"
            />
        </flux:tooltip>
